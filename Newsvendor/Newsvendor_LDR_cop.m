function [x,obj] =  Newsvendor_LDR_cop(data)
...
% CV for epsilon
epsilon_cop = epsilon_cop_value_LDR(data)/sqrt(Npoints);
...
obj = kappa+1/delta*(epsilon_cop*norm(Q-lambda*[zeros(2*N,1);1]*[zeros(2*N,1);1]',1) + trace(Q*Sigma0)); % Infinite-norm + last component
