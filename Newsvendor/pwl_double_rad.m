function [x,obj,out] =  pwl_double_rad(Sp,tp,hc,budget,mu,Sigma,N,M,A,b,eps)
...
for j = 1:M
    ...
    cons = [cons; MM + lambda2(j)*JJ >= 0; rho3{j} >= 0];
