function [x,obj] =  Newsvendor_LDR_cop_CV(data, epsilon0)
...
epsilon0 = epsilon0/sqrt(Npoints);
...
%% objective: min
obj = kappa+1/delta*(epsilon0*norm(Q-lambda*[zeros(2*N,1);1]*[zeros(2*N,1);1]',1) + trace(Q*Sigma0)); % Infinite-norm + last component
