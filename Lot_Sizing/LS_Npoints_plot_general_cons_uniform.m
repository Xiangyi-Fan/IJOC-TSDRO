...
while i < n
    ...
    N = Npoints(i)
    K = N;
    [avg_cop,avg_sp,avg_saa,avg_wass,cop0,cop100,sp0,sp100,saa0,saa100,wass0,wass100,feasibility_num,avg_T_cop,avg_T_sp,avg_T_saa,avg_T_wass] = outperformance_LS_general_cons_uniform(N,epsilon_cop_fix,epsilon_sp_fix,epsilon_cop_p_fix,epsilon_sp_p_fix);
