function [epsilon0_cop] =  LS_epsilon_cop_value_general(data_cons,data)
...
for i = 1:length(epsilon_dro_list)
    ...
    for j = 1:K0
        ...
        % DRO 
        [x_dro,obj_dro] = LS_PLD_cop_CV_general(data_cons,data_train,epsilon_dro);
        x_dro = double(x_dro);
...
epsilon0_cop = epsilon_dro_list(min_dro_index);
end