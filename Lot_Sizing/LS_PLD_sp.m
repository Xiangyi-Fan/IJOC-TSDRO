function [x,obj,runtime] =  LS_PLD_sp(cons_points,data,epsilon0)
...
for k = 1:K
    ...
    values = values + value{k}*num{k};
end
     
obj = C'*x + 1/Npoints*values; % Infinite-norm + last component
