...
for k = 1:K
    ...
    for l = 1:ll; sigma{l} = sdpvar(cc,1);end
    ...
    for l = 1:ll
        constraints1{end+1} = 0.5*((W{l}'*Y+gamma{l,1}*Q-ee*T_hat{l}')+(W{l}'*Y+gamma{l,1}*Q-ee*T_hat{l}')')-theta{l}*ee*ee'-0.5*(P{k,1}'*sigma{l}*ee'+ee*sigma{l}'*P{k,1}) >= 0;
    end
